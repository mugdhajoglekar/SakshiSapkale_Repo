...
values (4,'Dami','Dont know','dfg',45),
( 5,'Kumar','Dont know !!','ijk',12);
...
values( 2,'Ajinkya','dhule',99,'Ajinkya@gmail',22,2),
(3,'Adeelh','sangli',90,'Adeelh@gmail',22,3),
(4,'Dami','BSL',91,'dami@gmail',22,4),
(5,'kumar','BSL',92,'kumar@gmail',21,5);

SELECT name,address from student;

/*******update phone column datatype*******/
ALTER TABLE school ADD phone VARCHAR;